...
class Order(Base):
    ...
    products = relationship(
        "Product", secondary="order_product_association", back_populates="orders", overlaps="products_details"
    )
...
class Product(Base):
    ...
    # association many to many
    orders = relationship(
        "Order", secondary="order_product_association", back_populates="products", overlaps="orders_details"
    )
